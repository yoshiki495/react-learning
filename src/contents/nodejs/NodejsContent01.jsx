  ...
  return (
      ...
      <aside className="relative my-12 md:my-0 md:w-64 md:mr-12 lg:mr-20 md:shrink-0">
        ...
        <nav className={`md:block ${!sidebarNavOpen && 'hidden'}`}>
            ...
            <li className="py-2">
                ...
                >
                <li className="py-1">
                    <a className="text-gray-600 hover:underline" href="#nodejs">Node.jsとは何か</a>
                </li>
                <li className="py-1">
                    <a className="text-gray-600 hover:underline" href="#installation">Node.jsのインストール方法</a>
                </li>
                <li className="py-1">
                    <a className="text-gray-600 hover:underline" href="#howtouse">Node.jsの使い方</a>
                </li>
                </ul>
            </li>
            <li className="py-2">
                <a className="flex items-center hover:underline" href="/documentation/nodejs02">
                <div className="flex items-center grow">
                    <svg className="w-4 h-4 fill-current text-blue-600 mr-3 shrink-0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="md:grow">
      ...
      <div className="text-lg text-gray-600">
        <h2 className="h2 text-gray-900 mb-4">Node.jsの基礎を学ぶ</h2>
        <p className="mb-8">
        ...
        <h3 id="nodejs" className="h3 text-gray-900 mb-4" style={{ scrollMarginTop: '100px' }}>Node.jsとは何か</h3>
        <p className="mb-8">
        ...
        <h3 id="installation" className="h3 text-gray-900 mb-8" style={{ scrollMarginTop: '100px' }}>Node.jsのインストール方法</h3>
        ...
        <h3 id="howtouse" className="h3 text-gray-900 mb-8" style={{ scrollMarginTop: '100px' }}>Node.jsの使い方</h3>
        <p className="mb-8">
          Aenean sed adipiscing diam donec adipiscing tristique risus nec feugiat auctor urna nunc id cursus metus aliquam eleifend, arcu dictum varius duis at consectetur lorem donec massa sapien, sed risus ultricies tristique nulla aliquet. Morbi tristique senectus et netus et, nibh nisl condimentum id venenatis a condimentum vitae sapien.
        </p>
        <p className="mb-8">
...
export default NodejsContent01;